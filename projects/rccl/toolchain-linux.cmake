...
#
# Sets ROCM_PATH and AMD clang++/clang as the CXX compiler.
# Also sets CXX compiler flags for Release/Debug/RelWithDebInfo builds.
#
# Usage:
...
if(NOT (DEFINED ENV{CXXFLAGS} AND NOT "$ENV{CXXFLAGS}" STREQUAL ""))
    if(NOT CMAKE_CXX_FLAGS_DEBUG)
        # By default, we use -O1 for debug builds, as -O0 build of the entire RCCL project exceeds scratch space.
